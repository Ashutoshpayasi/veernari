...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index5-one-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:56:59 GMT -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <!--Services Start-->
        <section class="service-one" style="background-image: url(assets/images/shapes/service-bg-1.jpg);" id="service">
        ...
        <section class="testimonial-five" style="background-image: url(assets/images/shapes/testimonial-bg-5.png);" id="testimonial">
            <div class="container">
        ...
        <!--News Four Start-->
        <section class="news-four" id="news">
            <div class="container">
                <div class="section-title section-title--home-five text-center">
                    <span class="section-title__tagline">
                        <i class="section-title__tagline__left-icon oxpins-icon-two-heart"></i>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-footer-three__bottom-inner">
                                <p class="site-footer-three__bottom-text">© All Copyright 2023 by <a href="#">Oxpins.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
