...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/donations-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:58:01 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Donations List || Oxpins || Oxpins HTML 5 Template </title>
    <!-- favicons Icons -->
                ...
                <div class="donations-list__inner">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="donations-list__right">
                                    <div class="donations-list__content">
                                        ...
                                        <h3 class="donations-list__title"><a href="donation-details.php">Let’s
                                        ...
                                        <div class="donations-list__progress">
                                            <div class="donations-list__progress-shape"
                                                style="background-image: url(assets/images/shapes/donations-list-progress-shape-1.png);">
                                            </div>
                                            <div class="bar">
                    ...
                    <div class="donations-list__single">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="donations-list__img">
                                    <img src="assets/images/resources/donations-list-img-2.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6">
                                <div class="donations-list__right">
                                    <div class="donations-list__content">
                                        ...
                                        <h3 class="donations-list__title"><a href="donation-details.php">A Little Help
                                                can Heal their
                                                Pains</a></h3>
                                        <p class="donations-list__text">There are many of lorem, but majori have
                                            suffered alteration in some form. Et ligula ullamcorper malesuada proin
                    ...
                    <div class="donations-list__single">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="donations-list__img">
                                    <img src="assets/images/resources/donations-list-img-3.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6">
                                <div class="donations-list__right">
                                    <div class="donations-list__content">
                                        ...
                                        <h3 class="donations-list__title"><a href="donation-details.php">Raise Fund for
                                                Clean &Healthy
                                                Food</a></h3>
                                        <p class="donations-list__text">There are many of lorem, but majori have
                                            suffered alteration in some form. Et ligula ullamcorper malesuada proin
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="donations-list__right">
                                    <div class="donations-list__content">
                                        ...
                                        <h3 class="donations-list__title"><a href="donation-details.php">Give African
                                                Child a Good
                                                Education</a></h3>
                                        <p class="donations-list__text">There are many of lorem, but majori have
                                            suffered alteration in some form. Et ligula ullamcorper malesuada proin
...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/donations-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:58:10 GMT -->
</html>