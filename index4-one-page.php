...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index4-one-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:55:33 GMT -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <!--Main Slider Start-->
        <section class="main-slider-four clearfix" id="home">
        ...
        <!--Causes Four Start-->
        <section class="causes-four" id="donations">
            <div class="container">
        ...
        <section class="testimonial-four" style="background-image: url(assets/images/shapes/testimonial-bg-4.png);" id="testimonial">
        ...
        <!--Events Three Start-->
        <section class="events-three" id="events">
            <div class="container">
                <div class="section-title text-center">
