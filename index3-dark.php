...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index3-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:54:02 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Home Three || Oxpins || Oxpins HTML 5 Template </title>
    <!-- favicons Icons -->
                        ...
                        <div class="main-menu-three__right">
                            <div class="main-menu-three__right-inner">
                                ...
                                <div class="main-menu-three__btn-box">
                                    <a href="donate-now.php" class="main-menu-three__btn"> <span
                            ...
                            <div class="make-donation__right">
                                <div class="make-donation__content">
                                    <div class="make-donation__btn-box">
                                        <a href="donate-now.php" class="thm-btn make-donation__btn">Donate now</a>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-12">
                        <div class="feature-three__single">
                            <div class="feature-three__img"
                                style="background-image: url(assets/images/resources/feature-3-1-dark.png);"></div>
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="feature-three__single">
                            <div class="feature-three__img"
                                style="background-image: url(assets/images/resources/feature-3-2-dark.png);"></div>
                            <div class="feature-three__title-box">
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="feature-three__single">
                            <div class="feature-three__img"
                                style="background-image: url(assets/images/resources/feature-3-3-dark.png);"></div>
                            <div class="feature-three__title-box">
        ...
        <section class="causes-three">
            <div class="causes-three-bg-box">
                <div class="causes-three-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
                    style="background-image: url(assets/images/backgrounds/causes-three-bg.jpg);"></div>
                <div class="causes-three-shape-1"
                    style="background-image: url(assets/images/shapes/causes-three-shape-1-dark.png);"></div>
            </div>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="assets/images/resources/causes-3-1.jpg" alt="">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="assets/images/resources/causes-3-2.jpg" alt="">
                                <div class="causes-one__cat">
                                    <p>Medical</p>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="assets/images/resources/causes-3-3.jpg" alt="">
                                <div class="causes-one__cat">
                                    <p>Food</p>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="assets/images/resources/causes-3-4.jpg" alt="">
                                <div class="causes-one__cat">
                                    <p>Education</p>
                                </div>
                            </div>
                            <div class="causes-one__content">
                                <h3 class="causes-one__title"><a href="donation-details.php">The standard chunk of
                                        Lorem Ipsum text</a>
                                </h3>
                                <p class="causes-one__text">There are many of lorem, but majori have
                                    suffered alteration in some form.</p>
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-three__single">
                            ...
                            <div class="testimonial-three__shape-1"
                                style="background-image: url(assets/images/shapes/testimonial-three-shape-1-dark.png);">
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="events-two__left">
                            ...
                            <a href="event-details.php" class="thm-btn events-two__btn">Discover More</a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="events-two__right">
                            <div class="events-two__right-bg-box">
                                <div class="events-two-shape-2"
                                    style="background-image: url(assets/images/shapes/events-two-shape-2.png);"></div>
                            </div>
                            <ul class="list-unstyled events-two__list">
                                <li>
                                    <div class="events-two__img">
                                        <img src="assets/images/events/events-2-1.jpg" alt="">
                                    ...
                                    <div class="events-two__content">
                                        ...
                                        <h3 class="events-two__title"><a href="event-details.php">Pure hearts virtual
                                                <br> brain game</a></h3>
                                        <div class="events-two__read-more">
                                            <a href="event-details.php"> <span class="icon-right-arrow"></span> Read
                                                More</a>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="events-two__img">
                                        <img src="assets/images/events/events-2-2.jpg" alt="">
                                        <div class="events-two__date">
                                            <p>23 May, 2022</p>
                                        </div>
                                    </div>
...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index3-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:54:09 GMT -->
</html>