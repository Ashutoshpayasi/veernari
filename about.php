...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:57:29 GMT -->
<!-- Added by HTTrack -->
  ...
  <section class="about-four">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="team-card">
                <img src="assets/images/team/founder.jpg" alt="Founder" class="team-image">
                <div class="team-content">
                    <h3 class="team-name">Mr. Prashant Tewari</h3>
                    <p class="team-title">Founder</p>
                    <p class="team-bio">With over 15 years of experience, Mr. Prashant Tewari has dedicated his life to empowering VeerNaris. His vision drives the foundation towards impactful social change.</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12">
...
<div class="wrapper">
    <!-- Section Title -->
    <div class="section-title text-center">
        <h2 class="section-title__title" style="color: white;">Our Team</h2>
    </div>
    ...
    <div class="team-wrapper">
        <!-- Team Members -->
        <div class="members">
            <label for="m1" class="tile active">
        ...
        <div class="cards">
            <div class="card-wrapper">
                <!-- Founder -->
                <input type="radio" id="m1" name="members" checked />
                <div class="card">
                ...
                <div class="card">
                    <img src="assets/images/team/advisory.jpg" width="1413px" height="370px" class="avatar" />
                    <div class="info">
                        <div class="name">Advisory Team</div>
                        <div class="title">Advisory Board</div>
                        <div class="bio">
                            <p>Our esteemed advisory board consists of experienced professionals who provide invaluable guidance and strategic direction to the company. Their expertise in various industries helps shape business decisions and ensures long-term success.</p>
                            <p>With a wealth of knowledge and a commitment to innovation, the advisory team plays a crucial role in overseeing and enhancing the company’s operations, fostering growth, and maintaining excellence.</p>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:57:33 GMT -->
