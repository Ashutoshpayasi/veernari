...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index4-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:55:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Home Four || Oxpins || Oxpins HTML 5 Template </title>
    <!-- favicons Icons -->
    ...
    <link rel="stylesheet" href="assets/vendors/oxpins-icons-two/style.css">
    ...
    <link rel="stylesheet" href="assets/css/oxpins-update.css" />
    <link rel="stylesheet" href="assets/css/oxpins-color-1.css" />
    <link rel="stylesheet" href="assets/css/oxpins-dark.css" />
</head>

<body class="custom-cursor home-four-dark">
    ...
    <div class="page-wrapper">
        <header class="main-header-four">
            <nav class="main-menu main-header-four__inner">
                <div class="main-header-four__logo">
                    <a href="index.php"><img src="assets/images/resources/logo-3.png" width="135" alt="oxpins"></a>
                </div>
                    ...
                    <ul class="main-menu__list">
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    ...
                                                                                    <div class="demo-one__btns">
                                                                                        ...
                                                                                        <a href="index-dark.php" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                ...
                                                                                <div class="demo-one__image">
                                                                                    ...
                                                                                    <div class="demo-one__btns">
                                                                                        ...
                                                                                        <a href="index2-one-page.php" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="index2-dark.php" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                                ...
                                                                                <div class="demo-one__image">
                                                                                    ...
                                                                                    <div class="demo-one__btns">
                                                                                        ...
                                                                                        <a href="index3-one-page.php" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="index3-dark.php" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                                        <a href="index3.php">Home Page 03</a>
                                                                                    </h3><!-- /.demo-one__title -->
                                                                                </div><!-- /.demo-one__content -->
                                                                            </div><!-- /.demo-one__card -->
                                                                        </div><!-- /.col-md-6 -->
                                                                                ...
                                                                                <div class="demo-one__image">
                                                                                    ...
                                                                                    <div class="demo-one__btns">
                                                                                        ...
                                                                                        <a href="index4-one-page.php" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="index4-dark.php" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                                        <a href="index4.php">Home Page 04</a>
                                                                                    </h3><!-- /.demo-one__title -->
                                                                                </div><!-- /.demo-one__content -->
                                                                            </div><!-- /.demo-one__card -->
                                                                        </div><!-- /.col-md-6 -->
                                                                                ...
                                                                                <div class="demo-one__image">
                                                                                    ...
                                                                                    <div class="demo-one__btns">
                                                                                        ...
                                                                                        <a href="index5-one-page.php" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="index5-dark.php" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                                        <a href="index5.php">Home Page 05</a>
                                                                                    </h3><!-- /.demo-one__title -->
                                                                                </div><!-- /.demo-one__content -->
                                                                            </div><!-- /.demo-one__card -->
                                                                        </div><!-- /.col-md-6 -->
                        ...
                        <li class="dropdown">
                            ...
                            <ul>
                                ...
                                <li><a href="become-volunteer-two.php">Become volunteer</a></li>
                                <li><a href="volunteer-carousel.php">Volunteer carousel</a>
                                </li>
                ...
                <div class="main-header-four__btn">
                    <a href="donate-now.php" class="thm-btn">Donate Now</a>
                    ...
                    <a href="cart.php" class="main-header-four__cart"><i class="icon-shopping-cart"></i></a>
                </div>
            </nav>
        </header>
            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="main-slider-four__bg" style="background-image: url(assets/images/shapes/main-slider-4-1.png);"></div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7">
                                    <div class="main-slider-four__content">
                                        ...
                                        <div class="main-slider-four__btn-box">
                                            <a href="donate-now.php" class="thm-btn-two">Donate Now <i class="oxpins-icon-two-donate"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5">
                                    <div class="main-slider-four__image">
                                        <div class="main-slider-four__image__border" style="background-image: url(assets/images/shapes/slider-4-border.png);"></div>
                                        <div class="main-slider-four__image__inner">
                                            <img src="assets/images/resources/slider-4-1.jpg" alt="oxpins">
                                        </div>
                                        <div class="main-slider-four__image__shape-one"><img src="assets/images/shapes/slider-4-shape-1.png" alt="oxpins"></div>
                                        <div class="main-slider-four__image__shape-two"><img src="assets/images/shapes/slider-4-shape-2.png" alt="oxpins"></div>
                                        <div class="main-slider-four__image__shape-three"><img src="assets/images/shapes/slider-4-shape-3.png" alt="oxpins"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <ul class="pillar__wrapper">
                                <li class="pillar__item">
                                    <img src="assets/images/shapes/pillar-1.png" alt="oxpins">
                                    <span class="pillar__item__title">Kalima</span>
                                </li>
                                <li class="pillar__item">
                                    <img src="assets/images/shapes/pillar-2.png" alt="oxpins">
                                    <span class="pillar__item__title">Salat</span>
                                </li>
                                <li class="pillar__item">
                                    <img src="assets/images/shapes/pillar-3.png" alt="oxpins">
                                    <span class="pillar__item__title">Fasting</span>
                                </li>
                                <li class="pillar__item">
                                    <img src="assets/images/shapes/pillar-4.png" alt="oxpins">
                                    <span class="pillar__item__title">Hajj</span>
                                </li>
                                <li class="pillar__item">
                                    <img src="assets/images/shapes/pillar-5.png" alt="oxpins">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="about-five__image">
                                <div class="about-five__image__inner">
                                    <img src="assets/images/resources/about-5-1.jpg" alt="oxpins">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="about-five__content">
                                ...
                                <div class="about-five__feature hover-item" style="background-image: url(assets/images/shapes/about-5-feature-bg-dark.png);">
                                    <img src="assets/images/shapes/salary.png" alt="oxpins">
                                    ...
                                    <div class="hover-item__box">
                                        <img src="assets/images/resources/about-5-feature-1.jpg" alt="oxpins" class="hover-item__box-img">
                                    </div><!-- /.hover-item__box -->
                                </div>
                                <div class="about-five__feature hover-item" style="background-image: url(assets/images/shapes/about-5-feature-bg-dark.png);">
                                    <img src="assets/images/shapes/united.png" alt="oxpins">
        ...
        <section class="call-to-action">
            <div class="call-to-action__bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%" style="background-image: url(assets/images/backgrounds/call-to-action-bg.jpg);"></div>
            <div class="container text-center">
                <h2 class="call-to-action__title">
                    The Mosque is a Symbol of the<br> Strength and Resilience of Muslim<br> Communities
                </h2>
                <a href="checkout.php" class="thm-btn-two">Discover More</a>
            </div>
        </section>
        <!--Call To Action End-->
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="counter-two__image">
                                <img src="assets/images/resources/counter-1-1.jpg" alt="oxpins">
                            </div>
                        </div>
                        <div class="col-lg-8">
            ...
            <div class="container">
                ...
                <div class="row gutter-y-30">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="causes-four__single">
                            <div class="causes-four__img">
                                <img src="assets/images/resources/causes-4-1.jpg" alt="oxpins">
                            </div>
                            <div class="causes-four__content">
                                ...
                                <h3 class="causes-four__title">
                                    <a href="donation-details.php">Let’s Education for Children get Good Life</a>
                                </h3>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="150ms">
                        <div class="causes-four__single">
                            <div class="causes-four__img">
                                <img src="assets/images/resources/causes-4-2.jpg" alt="oxpins">
                            </div>
                            <div class="causes-four__content">
                                <div class="causes-four__cat">
                                    <p>Charity</p>
                                ...
                                <h3 class="causes-four__title">
                                    <a href="donation-details.php">It is a Long Established Fact Quran Teaching</a>
                                </h3>
                                <p class="causes-four__text">
                                    There are many variations of passages of Lorem Ip available, but the majority have suffered 
                                </p>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="causes-four__single">
                            <div class="causes-four__img">
                                <img src="assets/images/resources/causes-4-3.jpg" alt="oxpins">
                            </div>
                            <div class="causes-four__content">
                                <div class="causes-four__cat">
                                    <p>Medical</p>
                                ...
                                <h3 class="causes-four__title">
                                    <a href="donation-details.php">There are Many Variations of Passages</a>
                                </h3>
                                <p class="causes-four__text">
                                    There are many variations of passages of Lorem Ip available, but the majority have suffered 
                                </p>
        ...
        <section class="testimonial-four" style="background-image: url(assets/images/shapes/testimonial-bg-4-dark.png);">
            <div class="testimonial-four__shape" style="background-image: url(assets/images/shapes/testimonial-4-shape-dark.png);"></div>
            <div class="container">
                <div class="section-title text-center">
            ...
            <div class="testimonial-four__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{
                ...
                <div class="item">
                    ...
                    <div class="testimonial-four__single">
                        <div class="testimonial-four__single__shape" style="background-image: url(assets/images/shapes/testimonial-4-shape-two.png);"></div>
                        ...
                        <div class="testimonial-four__author">
                            <img src="assets/images/testimonial/testimonial-4-1.jpg" alt="oxpins">
                ...
                <div class="item">
                    ...
                    <div class="testimonial-four__single">
                        ...
                        <div class="testimonial-four__author">
                            <img src="assets/images/testimonial/testimonial-4-2.jpg" alt="oxpins">
                            <div class="testimonial-four__quote">
                                <span class="oxpins-icon-two-quote"></span>
                            </div>
                ...
                <div class="item">
                    ...
                    <div class="testimonial-four__single">
                        ...
                        <div class="testimonial-four__author">
                            <img src="assets/images/testimonial/testimonial-4-3.jpg" alt="oxpins">
                            <div class="testimonial-four__quote">
                                <span class="oxpins-icon-two-quote"></span>
                            </div>
                ...
                <div class="row gutter-y-30">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="events-three__item">
                            <img src="assets/images/events/events-3-1.jpg" alt="oxpins">
                            ...
                            <div class="events-three__item__hover">
                                ...
                                <h3 class="events-three__item__hover__title"><a href="event-details.php">Navigating Life's Journey with Faith</a></h3>
                                <a href="event-details.php" class="events-three__item__hover__rm"><i class="oxpins-icon-two-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="events-three__item">
                            <img src="assets/images/events/events-3-2.jpg" alt="oxpins">
                            <div class="events-three__item__normal">
                                <div class="events-three__item__normal__date">19 October 2023</div>
                                <div class="events-three__item__normal__meta">
                                    <p class="events-three__item__normal__meta__text"><i class="oxpins-icon-two-time"></i>9:00am</p>
                            ...
                            <div class="events-three__item__hover">
                                ...
                                <h3 class="events-three__item__hover__title"><a href="event-details.php">Embarking on a Journey Of Reflection</a></h3>
                                <a href="event-details.php" class="events-three__item__hover__rm"><i class="oxpins-icon-two-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="events-three__item">
                            <img src="assets/images/events/events-3-3.jpg" alt="oxpins">
                            <div class="events-three__item__normal">
                                <div class="events-three__item__normal__date">19 October 2023</div>
                                <div class="events-three__item__normal__meta">
                                    <p class="events-three__item__normal__meta__text"><i class="oxpins-icon-two-time"></i>9:00am</p>
                            ...
                            <div class="events-three__item__hover">
                                ...
                                <h3 class="events-three__item__hover__title"><a href="event-details.php">Exploring Islamic Insight & Wisdom</a></h3>
                                <a href="event-details.php" class="events-three__item__hover__rm"><i class="oxpins-icon-two-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
        ...
        <!--Donate Start-->
        <section class="donate-one" style="background-image: url(assets/images/shapes/donate-shape-bg-dark.png);">
            <div class="donate-one__shape" style="background-image: url(assets/images/shapes/donate-shape-1.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                    ...
                    <div class="col-xl-5">
                        <div class="donate-one__image wow slideInRight">
                            <img src="assets/images/resources/donate-1-1.jpg" alt="oxpins">
            ...
            <div class="container">
                ...
                <div class="row gutter-y-30">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="team-two__single">
                            <div class="team-two__single__image">
                                <img src="assets/images/team/team-2-1.png" alt="oxpins">
                            ...
                            <div class="team-two__single__content">
                                <h3 class="team-two__single__title"><a href="team-details.php">Julfiker Amin Ali</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="team-two__single">
                            <div class="team-two__single__image">
                                <img src="assets/images/team/team-2-2.png" alt="oxpins">
                                <div class="team-two__single__social">
                                    <a href="https://facebook.com/">
                                        <i class="fab fa-facebook-f" aria-hidden="true"></i>
                                        <span class="sr-only">Facebook</span>
                            ...
                            <div class="team-two__single__content">
                                <h3 class="team-two__single__title"><a href="team-details.php">Amin Hosseini</a></h3>
                                <p class="team-two__single__designation">Our Imam</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="team-two__single">
                            <div class="team-two__single__image">
                                <img src="assets/images/team/team-2-3.png" alt="oxpins">
                                <div class="team-two__single__social">
                                    <a href="https://facebook.com/">
                                        <i class="fab fa-facebook-f" aria-hidden="true"></i>
                                        <span class="sr-only">Facebook</span>
                            ...
                            <div class="team-two__single__content">
                                <h3 class="team-two__single__title"><a href="team-details.php">Sawad Bin Raiyan</a></h3>
                                <p class="team-two__single__designation">Our Imam</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 wow fadeInUp" data-wow-delay="100ms">
                        <div class="news-three__single">
                            <div class="news-three__single__img">
                                <img src="assets/images/blog/news-3-1.jpg" alt="oxpins">
                                <div class="news-three__single__cats">
                                    <a href="news-details.php">Charity</a>
                                </div>
                            </div>
                            <div class="news-three__single__content">
                                ...
                                <h3 class="news-three__single__title"><a href="news-details.php">Thanking to the Graces of Almighty Allah</a></h3>
                                <p class="news-three__single__text">
                                    There are many variations of passages of Lorem Ip available, but the majority have suffered 
                                </p>
                                <a class="news-three__single__rm" href="news-details.php">Read More<span class="oxpins-icon-two-arrow-right"></span></a>
                            </div>
                        </div>
                        <div class="news-three__single">
                            <div class="news-three__single__img">
                                <img src="assets/images/blog/news-3-2.jpg" alt="oxpins">
                                <div class="news-three__single__cats">
                                    <a href="news-details.php">Charity</a>
                                </div>
                            </div>
                            <div class="news-three__single__content">
                                ...
                                <h3 class="news-three__single__title"><a href="news-details.php">How Does the Nutrition Affect Children?</a></h3>
                                <p class="news-three__single__text">
                                    There are many variations of passages of Lorem Ip available, but the majority have suffered 
                                </p>
                                <a class="news-three__single__rm" href="news-details.php">Read More<span class="oxpins-icon-two-arrow-right"></span></a>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <ul class="news-three__list">
                            <li>
                                ...
                                <h3 class="news-three__list__title"><a href="news-details.php">We should be Thanking to the Graces of Our Almighty Allah</a></h3>
                            </li>
                            <li>
                                <div class="news-three__list__meta"><i class="oxpins-icon-two-comments"></i>2 Comments</div>
                                <h3 class="news-three__list__title"><a href="news-details.php">We should be Thanking to the Graces of Our Almighty Allah</a></h3>
            ...
            <div class="container">
                ...
                <div class="brand-four__carousel thm-owl__carousel owl-theme owl-carousel" data-owl-options='{
                    ...
                    <div class="brand-four__carousel__item">
                        <img src="assets/images/brand/brand-3-1-dark.png" alt="oxpins">
                    </div><!-- /.owl-slide-item-->
                    <div class="brand-four__carousel__item">
                        <img src="assets/images/brand/brand-3-1-dark.png" alt="oxpins">
                    </div><!-- /.owl-slide-item-->
        ...
        <section class="become-volunteer-two">
            <div class="container">
                <div class="become-volunteer-two__inner" style="background-image: url(assets/images/shapes/become-volunteer-shape-2.png);">
                    <h2 class="become-volunteer-two__title">Join your Hand with us for a<br> Better Life and Future</h2>
                    <a href="become-volunteer.php" class="thm-btn-two">Join as a Volunteer <i class="oxpins-icon-two-voluntary-work"></i></a>
                </div>
            </div>
        </section>
        ...
        <footer class="site-footer-two">
            <div class="site-footer-two__bg" style="background-image: url(assets/images/shapes/site-footer-two-bg.png);"></div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__column footer-widget__about">
                                <div class="footer-widget__about-logo">
                                    <a href="index.php"><img src="assets/images/resources/footer-logo-two.png" alt="oxpins"></a>
                                </div>
...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index4-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:55:40 GMT -->
</html>