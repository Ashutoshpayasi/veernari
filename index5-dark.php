...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index5-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:56:59 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Home Five || Oxpins || Oxpins HTML 5 Template </title>
    <!-- favicons Icons -->
    ...
    <link rel="stylesheet" href="assets/css/oxpins-color-2.css" />
    <link rel="stylesheet" href="assets/css/oxpins-dark.css" />
</head>

<body class="custom-cursor home-five-dark">
    ...
    <div class="page-wrapper">
        ...
        <header class="main-header-five">
            <nav class="main-menu main-header-five__inner">
                <div class="main-header-five__logo">
                    <a href="index.php"><img src="assets/images/resources/logo-4-dark.png" width="135" alt="oxpins"></a>
                </div>
                    ...
                    <ul class="main-menu__list">
                        ...
                        <li class="dropdown">
                            ...
                            <ul>
                                ...
                                <li><a href="become-volunteer-three.php">Become volunteer</a></li>
                ...
                <div class="main-header-five__btn">
                    <a href="contact.php" class="thm-btn-two">Appoinment</a>
                    ...
                    <a href="cart.php" class="main-header-five__cart"><i class="icon-shopping-cart"></i></a>
            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="main-slider-five__bg" style="background-image: url(assets/images/backgrounds/main-slider-5-1.jpg);"></div>
                        <div class="main-slider-five__shape" style="background-image: url(assets/images/shapes/main-slider-5-shape.png);"></div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="main-slider-five__content">
                                        ...
                                        <div class="main-slider-five__btn-box">
                                            <a href="contact.php" class="thm-btn-two">Get Started</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="main-slider-five__bg" style="background-image: url(assets/images/backgrounds/main-slider-5-2.jpg);"></div>
                        <div class="main-slider-five__shape" style="background-image: url(assets/images/shapes/main-slider-5-shape.png);"></div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
        ...
        <section class="feature-five">
            <div class="container">
                <div class="feature-five__inner" style="background-image: url(assets/images/shapes/feature-5-bg.png);">
                    <div class="feature-five__item">
                        ...
                        <a class="feature-five__item__rm" href="contact.php"></a>
                    </div><!-- fature-item -->
                    <div class="feature-five__item">
                        <div class="feature-five__item__icon">
                        ...
                        <a class="feature-five__item__rm" href="events.php"></a>
                    </div><!-- fature-item -->
                    <div class="feature-five__item">
                        <div class="feature-five__item__icon">
                        ...
                        <a class="feature-five__item__rm" href="volunteer.php"></a>
                    </div><!-- fature-item -->
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="100ms">
                        <div class="about-six__content">
                            ...
                            <a href="donate-now.php" class="thm-btn-two">Learn More</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-six__image">
                            <div class="about-six__image__one wow fadeInUp" data-wow-delay="100ms">
                                <img src="assets/images/resources/about-6-1.jpg" alt="oxpins">
                            </div>
                            <div class="about-six__image__two wow fadeInUp" data-wow-delay="200ms">
                                <img src="assets/images/resources/about-6-2.jpg" alt="oxpins">
                            </div>
        ...
        <!--Services Start-->
        <section class="service-one" style="background-image: url(assets/images/shapes/service-bg-1-dark.png);">
            <div class="service-one__shape" style="background-image: url(assets/images/shapes/service-shape-1.png);"></div>
            <div class="container">
                        ...
                        <div class="service-one__item">
                            <div class="service-one__item__normal">
                                ...
                                <div class="service-one__item__normal__thumb">
                                    <img src="assets/images/resources/service-1-1-normal.jpg" alt="oxpins">
                                </div>
                            </div><!-- feature-normal-content -->
                            <div class="service-one__item__hover" style="background-image: url(assets/images/resources/service-1-1.jpg);">
                                ...
                                <div class="service-one__item__hover__btn"><a href="about.php"><i class="oxpins-icon-two-arrow-right-two"></i></a></div>
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="service-one__item">
                            <div class="service-one__item__normal">
                                ...
                                <p class="service-one__item__normal__text">There are many variations of passages  Lorem Ipiosum aagtilable but the</p>
                                <div class="service-one__item__normal__thumb">
                                    <img src="assets/images/resources/service-1-2-normal.jpg" alt="oxpins">
                                </div>
                            </div><!-- feature-normal-content -->
                            <div class="service-one__item__hover" style="background-image: url(assets/images/resources/service-1-2.jpg);">
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="service-one__item">
                            <div class="service-one__item__normal">
                                ...
                                <p class="service-one__item__normal__text">There are many variations of passages  Lorem Ipiosum aagtilable but the</p>
                                <div class="service-one__item__normal__thumb">
                                    <img src="assets/images/resources/service-1-3-normal.jpg" alt="oxpins">
                                </div>
                            </div><!-- feature-normal-content -->
                            <div class="service-one__item__hover" style="background-image: url(assets/images/resources/service-1-3.jpg);">
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="service-one__item">
                            <div class="service-one__item__normal">
                                ...
                                <p class="service-one__item__normal__text">There are many variations of passages  Lorem Ipiosum aagtilable but the</p>
                                <div class="service-one__item__normal__thumb">
                                    <img src="assets/images/resources/service-1-4-normal.jpg" alt="oxpins">
                                </div>
                            </div><!-- feature-normal-content -->
                            <div class="service-one__item__hover" style="background-image: url(assets/images/resources/service-1-4.jpg);">
            ...
            <div class="container">
                ...
                <div class="row gutter-y-30">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="causes-five__single">
                            <div class="causes-five__img">
                                <img src="assets/images/resources/causes-5-1.jpg" alt="oxpins">
                            </div>
                            <div class="causes-five__content">
                                ...
                                <h3 class="causes-five__title">
                                    <a href="donation-details.php">Support Seniors Every Step of the Way</a>
                                </h3>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="causes-five__single">
                            <div class="causes-five__img">
                                <img src="assets/images/resources/causes-5-2.jpg" alt="oxpins">
                            </div>
                            <div class="causes-five__content">
                                <div class="causes-five__cat">
                                    <p>Medical</p>
                                ...
                                <h3 class="causes-five__title">
                                    <a href="donation-details.php">We Give Seniors The Love They Deserve</a>
                                </h3>
                                <div class="causes-five__progress">
                                    <div class="bar">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="causes-five__single">
                            <div class="causes-five__img">
                                <img src="assets/images/resources/causes-5-3.jpg" alt="oxpins">
                            </div>
                            <div class="causes-five__content">
                                <div class="causes-five__cat">
                                    <p>Care</p>
                                ...
                                <h3 class="causes-five__title">
                                    <a href="donation-details.php">The Nation's No.1 esse Cillum Home Care</a>
                                </h3>
                                <div class="causes-five__progress">
                                    <div class="bar">
                ...
                <div class="causes-five__bottom">
                    ...
                    <a href="donate-now.php" class="thm-btn-two">Donate Now</a>
                </div>
            </div>
        </section>
        <!--Causes Five End-->
        ...
        <section class="become-volunteer-three">
            <div class="container">
                <div class="become-volunteer-three__inner" style="background-image: url(assets/images/shapes/become-volunteer-shape-3.png);">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="become-volunteer-three__content">
                                ...
                                <a href="contact.php" class="thm-btn-two">Get In Touch</a>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="become-volunteer-three__image">
                                <img src="assets/images/resources/become-volunteer-three.png" alt="oxpins">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="testimonial-five" style="background-image: url(assets/images/shapes/testimonial-bg-5-dark.png);">
            <div class="container">
                ...
                <div class="testimonial-five__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-five__single">
                            <div class="testimonial-five__single__shape" style="background-image: url(assets/images/shapes/testimonial-5-shape-dark.png);"></div>
                            ...
                            <div class="testimonial-five__author">
                                <img src="assets/images/testimonial/testimonial-5-1.jpg" alt="oxpins">
                                <h3 class="testimonial-five__title">Kenneth S.</h3>
                                <p class="testimonial-five__designation">Volunteer</p>
                            </div>
                            <div class="testimonial-five__single__quote" style="background-image: url(assets/images/shapes/testimonial-5-quote.png);"></div>
                        </div>
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-five__single">
                            ...
                            <div class="testimonial-five__author">
                                <img src="assets/images/testimonial/testimonial-5-2.jpg" alt="oxpins">
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-five__single">
                            ...
                            <div class="testimonial-five__author">
                                <img src="assets/images/testimonial/testimonial-5-3.jpg" alt="oxpins">
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-five__single">
                            ...
                            <div class="testimonial-five__author">
                                <img src="assets/images/testimonial/testimonial-5-4.jpg" alt="oxpins">
        ...
        <!--Why Choose Start-->
        <section class="why-choose-one" style="background-image: url(assets/images/shapes/why-choose-bg.png);">
            <div class="why-choose-one__image">
                <img src="assets/images/resources/why-choose-1.jpg" alt="oxpins">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
        ...
        <section class="counter-three">
            <div class="counter-three__bg" style="background-image: url(assets/images/shapes/counter-bg-3.jpg);"></div>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="faq-three__image">
                            <img src="assets/images/resources/faq-3-1.jpg" alt="oxpins">
                            <div class="faq-three__info">
                                <div class="faq-three__info__icon"><img src="assets/images/shapes/faq-three-icon.png" alt="oxpins"></div>
                                <h5 class="faq-three__info__title">Still have Questions?</h5>
                                <p class="faq-three__info__text">Sent to <a href="mailto:needhelp@company.com">Needhelp@company.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="news-four__single">
                            <div class="news-four__single__content">
                                ...
                                <h3 class="news-four__single__title"><a href="news-details.php">10 Simple Practices Will Help You Free Get 1% Better Every Day</a></h3>
                                <a class="news-four__single__rm" href="news-details.php">Read More</a>
                            </div>
                            <div class="news-four__single__img">
                                <img src="assets/images/blog/news-4-1.jpg" alt="oxpins">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="news-four__single news-four__single--reverse">
                            <div class="news-four__single__content">
                                <div class="news-four__single__meta"><i class="oxpins-icon-two-comments"></i>2 Comments</div>
                                <h3 class="news-four__single__title"><a href="news-details.php">Solution This Business For is company fast Marketing Blog</a></h3>
                                <a class="news-four__single__rm" href="news-details.php">Read More</a>
                            </div>
                            <div class="news-four__single__img">
                                <img src="assets/images/blog/news-4-2.jpg" alt="oxpins">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="news-four__single">
                            <div class="news-four__single__content">
                                <div class="news-four__single__meta"><i class="oxpins-icon-two-comments"></i>2 Comments</div>
                                <h3 class="news-four__single__title"><a href="news-details.php">Business Web Agency This Business company Fast Solution Blog</a></h3>
                                <a class="news-four__single__rm" href="news-details.php">Read More</a>
                            </div>
                            <div class="news-four__single__img">
                                <img src="assets/images/blog/news-4-3.jpg" alt="oxpins">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer class="site-footer-three">
            <div class="site-footer-three__bg" style="background-image: url(assets/images/shapes/site-footer-three-bg.png);"></div>
            <div class="site-footer-three__wrapper">
                <div class="container">
                    <div class="site-footer-three__top">
                        <div class="site-footer-three__logo">
                            <a href="index.php"><img src="assets/images/resources/footer-logo-three.png" alt="oxpins"></a>
                        </div>
...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index5-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:57:07 GMT -->
</html>