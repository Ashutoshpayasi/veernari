...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:52:11 GMT -->
    ...
    <div class="page-wrapper">
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    ...
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="index.php" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="index-one-page.php" target="_blank" class="thm-btn">One Page</a>
                                                                                        <a href="index-dark.php" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    <img width="370" height="431" src="assets/images/home-showcase/home-1-2.png"
                                                                                        alt="Home Page 02">
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="index2.php" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="index2-one-page.php" target="_blank" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="index2-dark.php" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    <img width="370" height="431" src="assets/images/home-showcase/home-1-3.png"
                                                                                        alt="Home page 03">
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="index3.php" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="index3-one-page.php" target="_blank" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="index3-dark.php" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    <img width="370" height="431" src="assets/images/home-showcase/home-1-4.png"
                                                                                        alt="Home page 04">
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="index4.php" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="index4-one-page.php" target="_blank" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="index4-dark.php" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    <img width="370" height="431" src="assets/images/home-showcase/home-1-5.png"
                                                                                        alt="Home page 05">
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="index5.php" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="index5-one-page.php" target="_blank" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="index5-dark.php" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                        ...
                        <div class="about-one__left">
                            <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-one__shape-3 float-bob-y">
                                    <img src="assets/images/shapes/about-one-shape-3-dark.png" alt="">
                                </div>
                        ...
                        <div class="about-one__right">
                            ...
                            <ul class="list-unstyled about-one__points">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <h5><a href="donate-now.php">Start donating</a></h5>
                                        <p>Lorem ipsum dolor sit amet not quis mis notted.</p>
                                    </div>
                                </li>
                            </ul>
        ...
        <section class="become-volunteer-one">
            ...
            <div class="become-volunteer-one__shape-1"
                style="background-image: url(assets/images/shapes/become-volunteer-shape-1-dark.png);"></div>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6  wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                        <div class="feature-one__single">
                            ...
                            <div class="feature-one__top">
                                <div class="feature-one__top-inner">
                                    ...
                                    <div class="feature-one__top-title-box">
                                        <h3 class="feature-one__top-title"><a href="donation-details.php">Join us &
                                                become <br> a
                                                volunteer</a></h3>
                                    </div>
                                </div>
                            ...
                            <a href="donation-details.php" class="thm-btn feature-one__btn">View details</a>
                        </div>
                    </div>
...
<!-- Mirrored from pixydrops.com/oxpinshtml/main-html/index-dark.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 06:52:22 GMT -->
</html>